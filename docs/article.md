...
Меня зовут Волжанин Александр, я заканчиваю 4-ый курс бакалавриата, эта статья по моей ВКР. В этой статье я бы хотел предложить метод обработки большого кол-ва токенов с помощью малых языковых моделей на потребительском GPU до 8 гб. Я бы не относился к этой статье слишком серьёзно: исследованием её можно назвать лишь с очень большой натяжкой. Скорее это инженерный проект с выводом и гипотезами. Буду рад любой обратной связи.
...
(*Формально single-call можно уместить в бюджет 8 ГБ, понизив число параметров модели или применив более агрессивную квантизацию. В пределах этого бюджета мы фиксируем модель максимальной параметрической ёмкости при выбранной разрядности квантизации учитывая наш бюджет; компромисс «меньшая ёмкость модели в обмен на single-call по более длинному контексту» систематически не исследовался.)
