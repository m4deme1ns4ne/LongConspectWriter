...
*Рис. 3. Профиль оценок по семи парадигмам для лекции «Основные понятия химии» (LCW против Gemini 3.1 Pro). LCW почти смыкается с эталоном по полноте (P6), самодостаточности (P7) и структуре (P1) и заметно отстаёт по визуализации (P4) и строгости (P3).*
