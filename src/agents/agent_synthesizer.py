...
from src.core.base import BaseLlamaCppAgent, BaseTransformersAgent
from src.core.utils import TextsSplitter, TqdmTokenStreamer, bad_words_id_generate
...
class AgentSynthesizerTransformers(BaseTransformersAgent):
    def __init__(self, init_config, gen_config, app_config):
        super().__init__(init_config, gen_config, app_config)
